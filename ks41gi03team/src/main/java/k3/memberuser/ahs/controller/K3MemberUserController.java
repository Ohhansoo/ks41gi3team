...
//		public String k3DeleteMemberUser(@RequestParam(value="deleteList[]", required = false) List<String>deleteList) {
	 ...
	 * //현황 + 검색
	 * 
	 * @GetMapping("/k3MemberUserList") public String
	 * k3GetMemberUserSearchList(@RequestParam(value="searchKey", required = false)
	 * String searchKey,
	 * 
	 ...
	 * 
	 * if(searchValue != null && searchValue !="".toString()) { Map<String, Object>
	 * resultMap = memberuserService.k3GetMemberUserSearchList(searchKey,
	 * searchValue, searchStartDate, searchEndDate, currentPage);
	 * 
	 * model.addAttribute("lastPage", resultMap.get("lastPage"));
	 * model.addAttribute("startPageNum", resultMap.get("startPageNum"));
	 * model.addAttribute("endPageNum", resultMap.get("endPageNum"));
	 * model.addAttribute("searchKey", searchKey); model.addAttribute("searchValue",
	 * searchValue); model.addAttribute("memberuserList",
	 * resultMap.get("memberuserList")); }else if(searchStartDate != null &&
	 * searchStartDate != "".toString() && searchEndDate != null && searchEndDate !=
	 * "".toString()) { Map<String, Object> resultMap =
	 * memberuserService.k3GetMemberUserSearchList(searchKey, searchValue,
	 * searchStartDate, searchEndDate, currentPage);
	 * 
	 * model.addAttribute("lastPage", resultMap.get("lastPage"));
	 * model.addAttribute("startPageNum", resultMap.get("startPageNum"));
	 * model.addAttribute("endPageNum", resultMap.get("endPageNum"));
	 ...
	 * model.addAttribute("memberuserList", resultMap.get("memberuserList")); }else
	 ...
	 * }
	 * 
	 * model.addAttribute("title", "회원관리"); model.addAttribute("subtitle", "직원현황");
