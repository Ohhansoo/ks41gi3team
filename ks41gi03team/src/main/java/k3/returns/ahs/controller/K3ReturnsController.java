...
@Controller
@RequestMapping(value="/team03/returns")
public class K3ReturnsController {
	...
	public String k3AddReturns(){
		...
		return "team03/returns/k3AddReturns";
	}
	//입출하하자품 등록폼 이동
	@GetMapping("/k3AddFlaw")
	public String k3AddFlaw(){
		
		return "team03/returns/k3AddFlaw";
	}
	...
	public String k3GetReturnsList() {
		...
		return "team03/returns/k3ReturnsList";
	}
	...
	public String k3GetFlawList() {
		...
		return "team03/returns/k3FlawList";
	}
}
